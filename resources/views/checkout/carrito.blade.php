    ...
    <div style="max-width:900px; margin:0 auto; padding:24px;">
        ...
        <div style="display:flex; flex-wrap:wrap; gap:40px;">
            ...
            <div style="flex:1 1 300px;">
                <h2 style="font-size:13px; letter-spacing:0.08em; text-transform:uppercase; color:#666; margin-bottom:16px;">Tu pedido</h2>
            ...
            {{-- FORMULARIO --}}
            <div style="flex:1 1 300px;">
                <form action="{{ route('checkout.carrito.store') }}" method="POST">
                    @csrf
